from ratroyale.backend.player_info.player_info import PlayerInfo, protect, unprotect
...
def test_player_info_test_load(example_player_info: PlayerInfo) -> None:
    ...
    assert player_info_bytes == unprotect(
        protect(PlayerInfo.load(player_info_bytes).save())
    )
