...
class PlayerInfo:
    ...
    def __init__(self, all_squeaks: list[Squeak], squeak_sets: list[set[int]], selected_squeak_set_index: int) -> None:
        self.all_squeaks = all_squeaks
        self.squeak_sets = [SqueakSet(squeak_set, self)
                            for squeak_set in squeak_sets]
