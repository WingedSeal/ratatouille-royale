...
) -> dict[ActionKey, Callable[[InputManagerEvent], None]]:
    return {
        ActionKey.START_GAME: lambda tkn: manager.message(
        ...
        ActionKey.PAUSE_GAME: lambda tkn: manager.message(
            AddPageEvent_PageManagerEvent(PageName.PAUSE_MENU)
        ),
        ActionKey.RESUME_GAME: lambda tkn: manager.message(
            RemovePageEvent_PageManagerEvent(PageName.PAUSE_MENU)
        ),
