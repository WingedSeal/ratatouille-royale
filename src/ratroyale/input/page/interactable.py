...
class Interactable:
    ...
    def __init__(
        ...
        self.gesture_action_mapping: dict[GestureKey, ActionKey] = (
...
class TileInteractable(Interactable):
    ...
    def __init__(self, tile: Tile, blocks_input: bool = True, z_order: int = 0) -> None:
        ...
        gesture_action_mapping = {GestureKey.CLICK: ActionKey.SELECT_TILE}
...
class EntityInteractable(Interactable):
    ...
    def __init__(
        self, entity: Entity, blocks_input: bool = True, z_order: int = 1
    ) -> None:
        ...
        self.gesture_action_mapping = {GestureKey.CLICK: ActionKey.SELECT_UNIT}
