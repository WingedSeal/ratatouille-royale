...
class InspectHistory(Page):
    def __init__(self, coordination_manager: "CoordinationManager", camera: Camera) -> None:
        super().__init__(coordination_manager, is_blocking=True, theme_name="inspect_history", camera=camera)
    ...
    def on_click_outside(self, msg: pygame.event.Event) -> None:
        ...
        panel = self._element_manager.get_element_wrapper("inspect_history_panel", "inspect_history")
