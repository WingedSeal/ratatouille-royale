...
from ratroyale.frontend.interactables_management.interactable import Interactable
...
from ratroyale.frontend.interactables_management.interaction_type import InteractionType
